#
# Code adapted from https://github.com/KU-CVLAB/CAT-Seg/blob/main/cat_seg/data/datasets/register_coco_stuff.py
#
...
def register_all_coco_stuff_10k(root):
    ...
    for name, image_dirname, sem_seg_dirname in [
        ("train", "COCO_stuff_images/train2017", "annotations_detectron2/train2017"),
        ("test", "COCO_stuff_images/val2017", "annotations_detectron2/val2017"),
    ]:
...
_root = os.getenv("DETECTRON2_DATASETS", "/scratch/t.tovi/datasets")
